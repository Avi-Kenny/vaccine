...
test_that("est_med", {
  ...
  expect_equal(ests_med_NP_nie$est, 2.731783, tolerance=0.01)
  expect_equal(ests_med_NP_nie$se, 3.023052, tolerance=0.01)
  expect_equal(ests_med_NP_nie$ci_lower, 0.312227, tolerance=0.01)
  expect_equal(ests_med_NP_nie$ci_upper, 23.90132, tolerance=0.01)
  expect_equal(ests_med_NP_pm$est, 0.3021856, tolerance=0.01)
  expect_equal(ests_med_NP_pm$se, 0.334483, tolerance=0.01)
  expect_equal(ests_med_NP_pm$ci_lower, -0.3534011, tolerance=0.01)
  expect_equal(ests_med_NP_pm$ci_upper, 0.9577722, tolerance=0.01)
})
