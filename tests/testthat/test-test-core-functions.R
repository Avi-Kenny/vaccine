...
test_that("est_med", {
  ...
  expect_equal(ests_med_NP_nde$est, 20.35041, tolerance=0.01)
  expect_equal(ests_med_NP_nde$se, 10.57582, tolerance=0.01)
  expect_equal(ests_med_NP_nde$ci_lower, 7.348651, tolerance=0.01)
  expect_equal(ests_med_NP_nde$ci_upper, 56.35583, tolerance=0.01)
  expect_equal(ests_med_NP_nie$est, 1.03442, tolerance=0.01)
  expect_equal(ests_med_NP_nie$se, 0.2177699, tolerance=0.01)
  expect_equal(ests_med_NP_nie$ci_lower, 0.6846922, tolerance=0.01)
  expect_equal(ests_med_NP_nie$ci_upper, 1.562782, tolerance=0.01)
  expect_equal(ests_med_NP_pm$est, 0.01110645, tolerance=0.01)
  expect_equal(ests_med_NP_pm$se, 0.068966, tolerance=0.01)
  expect_equal(ests_med_NP_pm$ci_lower, -0.1240669, tolerance=0.01)
  expect_equal(ests_med_NP_pm$ci_upper, 0.1462798, tolerance=0.01)
})
